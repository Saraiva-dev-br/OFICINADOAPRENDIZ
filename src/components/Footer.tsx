...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="bg-[#17081d] text-[#d7a8df] pt-8 pb-6 border-t border-[#381044]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8 pb-6 border-b border-[#381044]">
          
          {/* Brand Info */}
          <div className="lg:col-span-5 space-y-3">
            <div className="flex items-center gap-3">
              <div className="overflow-hidden rounded-2xl bg-white p-1.5 shadow-md shrink-0 flex items-center justify-center">
                <img 
                  src="/logo-icon.png" 
              ...
              <div className="flex flex-col justify-center">
                ...
                <span className="text-xs font-black text-[#ffc928] uppercase tracking-wider">
                  Teresina · Piauí
                </span>
              </div>
            </div>

            <p className="text-xs text-[#d7a8df] max-w-sm leading-relaxed">
            ...
            <div className="pt-1 flex items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#ffc928] hover:bg-[#e6b420] text-[#28102d] text-xs font-black transition shadow-xs"
              >
          ...
          <div className="lg:col-span-4 space-y-2.5">
            ...
            <div className="space-y-2.5 text-xs">
              <div className="p-3 rounded-xl bg-[#23092c] border border-[#381044]">
                <div className="flex items-center justify-between text-[#ffc928] font-black mb-1">
                  <span>Unidade Dirceu</span>
                  <span className="text-[10px] text-[#d7a8df] font-normal">Parque Ideal</span>
                </div>
                <p className="text-[#e9dfea] text-[11px] leading-relaxed">R. Dr. Pedro Teixeira, 2964 - Parque Ideal</p>
                <p className="text-[#a597a8] text-[10px] mt-0.5">Seg. a sex.: 08h às 17h · Sáb.: 08h às 12h</p>
              </div>

              <div className="p-3 rounded-xl bg-[#23092c] border border-[#381044]">
                <div className="flex items-center justify-between text-[#ffc928] font-black mb-1">
                  <span>Unidade Centro</span>
                  <span className="text-[10px] text-[#d7a8df] font-normal">Ed. Cel. Otávio Miranda</span>
                </div>
                <p className="text-[#e9dfea] text-[11px] leading-relaxed">Edifício Coronel Otávio Miranda: Rua Rui Barbosa, nº 68, Centro - 6º Andar, sala 613</p>
                <p className="text-[#a597a8] text-[10px] mt-0.5">Seg. a sex.: 08h às 17h · Sáb.: 08h às 12h</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 pt-1">
              <button
                ...
                className="text-xs text-[#ffc928] hover:underline font-bold"
              >
                Teste Vocacional
              </button>
              ...
              <button
                ...
                className="text-xs text-[#d7a8df] hover:text-white font-bold"
              >
                Portal do Aluno
              </button>
            </div>
        ...
        {/* Legal & Copyright */}
        <div className="pt-4 text-xs text-[#a597a8] flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-center sm:text-left max-w-2xl leading-relaxed text-[11px]">
          ...
          <div className="flex items-center gap-2 text-[#d7a8df] shrink-0 text-xs">
