  ...
  return (
    <div className="fixed bottom-6 right-4 sm:right-6 z-40 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className="hidden sm:flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-[#531062] hover:bg-[#6c167f] text-[#ffc928] border border-[#ffc928]/50 text-xs font-black shadow-xl transition transform hover:scale-105 active:scale-95"
      >
      ...
      <a
        ...
        className="group flex items-center gap-2.5 px-4 py-3 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 active:scale-95 border-2 border-white/40"
      >
