...
export const VocationalModal: React.FC<VocationalModalProps> = ({
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-xs p-4 sm:p-6 overflow-y-auto animate-in fade-in duration-200"
      onClick={onClose}
    >
      <div 
        className="relative w-full max-w-2xl bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 my-6 flex flex-col"
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#531062] via-[#4b0d59] to-[#25102b] p-6 text-white relative">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-[#ffc928]/20 border border-[#ffc928]/40 text-[#ffc928] text-xs font-black uppercase tracking-wider mb-2">
            <BrainCircuit className="w-3.5 h-3.5 text-[#ffc928]" />
          ...
          {step === 'quiz' && (
            <div className="mt-5">
              <div className="flex justify-between text-[11px] font-bold text-[#ffc928] mb-1.5">
              ...
              <div className="w-full h-2 bg-[#25102b] rounded-full overflow-hidden">
                <div 
        ...
        <div className="p-6 sm:p-8">
          ...
          {step === 'intro' && (
            <form onSubmit={startQuiz} className="space-y-6">
              <div className="bg-[#f7f3f8] border border-[#eadfeb] rounded-2xl p-5 text-[#4d3e51] text-xs sm:text-sm leading-relaxed">
                <p className="font-black text-[#25102b] mb-1">Como funciona o teste?</p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-sm rounded-xl border border-[#eadfeb] focus:outline-hidden focus:ring-2 focus:ring-[#812392] bg-[#f7f3f8] focus:bg-white transition"
                  />
                </div>
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 text-sm font-black text-[#28102d] bg-[#ffc928] hover:bg-[#e6b420] active:bg-[#d4a317] rounded-xl shadow-md transition"
              >
          ...
          {step === 'quiz' && (
            <div className="space-y-6">
              <div>
                ...
                <h4 className="text-lg sm:text-xl font-black text-[#25102b] mt-1 mb-2 leading-snug">
                  {currentQ.title}
                </h4>
              ...
              <div className="space-y-3">
                {currentQ.options.map((opt, i) => (
                  <button
                    ...
                    className="w-full p-4 rounded-2xl border-2 border-[#eadfeb] hover:border-[#812392] hover:bg-[#f7f3f8] text-left transition duration-200 flex items-start gap-3 group"
                  >
                    <span className="w-6 h-6 rounded-full border border-[#eadfeb] group-hover:border-[#531062] group-hover:bg-[#531062] group-hover:text-[#ffc928] flex items-center justify-center text-xs font-black shrink-0 mt-0.5 transition">
                      {String.fromCharCode(65 + i)}
                    </span>
                    <span className="text-xs sm:text-sm font-semibold text-[#4d3e51] group-hover:text-[#25102b] leading-relaxed">
                      {opt.label}
                    </span>
                  </button>
                ))}
              ...
              {currentQuestionIdx > 0 && (
                <div className="pt-2 flex justify-start">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#716575] hover:text-[#25102b]"
                  >
          ...
          {step === 'result' && (
            <div className="space-y-6 text-center">
              ...
              <div>
                ...
                <h4 className="text-2xl sm:text-3xl font-black text-[#25102b] mt-1 mb-3">
                  {resultData.title}
                </h4>
                <p className="text-xs sm:text-sm text-[#6c6570] max-w-xl mx-auto leading-relaxed">
                  {resultData.description}
                </p>
              </div>

              {/* Skills Highlights */}
              <div className="bg-[#f7f3f8] border border-[#eadfeb] rounded-2xl p-5 text-left">
                <span className="text-xs font-black uppercase tracking-wider text-[#25102b] block mb-3">
                  Suas principais forças identificadas:
                </span>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {resultData.skills.map((sk, idx) => (
                    <div key={idx} className="flex items-center gap-2 text-xs font-bold text-[#4d3e51] bg-white p-2.5 rounded-xl border border-[#eadfeb]">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
                <button
                  ...
                  className="w-full sm:flex-1 inline-flex items-center justify-center gap-2 py-3.5 px-6 text-xs sm:text-sm font-black text-[#28102d] bg-[#ffc928] hover:bg-[#e6b420] active:bg-[#d4a317] rounded-xl shadow-md transition"
                >
                ...
                <button
                  onClick={resetQuiz}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 py-3 px-4 text-xs font-bold text-[#531062] bg-[#f7f3f8] hover:bg-[#efe3f2] border border-[#eadfeb] rounded-xl transition"
                >
                  <RotateCcw className="w-3.5 h-3.5 text-[#812392]" />
